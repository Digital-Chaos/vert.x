...
public class HTTPExamples {
  ...
  public void example31(Vertx vertx) {
    ...
    client.request(HttpMethod.GET, "foo.othercompany.com", "/other-uri", ar1 -> {
      if (ar1.succeeded()) {
        HttpClientRequest request = ar1.result();
        request.send(ar2 -> {
          if (ar2.succeeded()) {
  ...
  public void sendRequest01(HttpClientRequest request) {
  ...
  public void sendRequest02(HttpClientRequest request) {
